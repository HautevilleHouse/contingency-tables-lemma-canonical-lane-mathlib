import ContingencyTablesLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement :=
  { sourceKey := sourceRepository,
    ...
    manifoldConstrainedStatement := "contingency-tables-lemma: independence testable via conditional odds-ratio product constraint on admissible cells",
